...
def genpointworkload(parquetdir, column):
    ...
    wf = open("sparseworst.workload", "w+", encoding="UTF-8")
    for _point in _points:
        wf.write("point:{}\n".format(_point))
    wf.close()
    shutil.copy2('sparseworst.workload', '../../../cuckoo-index/searchlogs/sparseworst.workload')
...
def compare(parquetdir, column):
    ...
    f = open("sparseworst.workload", "r+", encoding="UTF-8")
    for line in f:
        expnum += 1
