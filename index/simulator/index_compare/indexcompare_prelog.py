...
if __name__=="__main__":
    ...
    prelogs = ["./prelogs/store_sales_100.workload",
               "./prelogs/wiki.workload",
               "./prelogs/maps.workload"]
    ...
    for i in range(len(directorys)):
        ...
        compareCurDataset(directorys[i], columns[i], prelogs[i])
        parquets2csvs(directorys[i], cuckoo_datadir[i])
        shutil.copy2(prelogs[i], cuckoo_workloads[i])
