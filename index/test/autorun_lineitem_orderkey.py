...
def write_file(index, rowgroups):
    ...
    for file in files:
        os.system("aws s3 cp {} s3://sievel/lineitemorderkey_{}/{}".format(write_file_dir + file, index, file))
...
for _range in _range_list:
    ...
    with ThreadPoolExecutor(5, thread_name_prefix='autorun_lineitem_orderkey_pool') as pools:
        all_task = []
