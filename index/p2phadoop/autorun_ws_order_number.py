# 自动化的测试脚本
# nohup python3 -u tmep.py 1>std.log 2>strr.log &
import os
import sys
import time
...
args.wltype = "tpcds"
args.table = "web_sales"
args.column = "ws_order_number"
bandwith = "30000"
simulate_file = "tpcds-ws_order_number.log"
...
hdfs_delete_dir = "/tpcds_origin/{}".format(args.table)
hdfs_write_dir = "/tpcds_origin/"
os.system("hadoop fs -rm -r -skipTrash " + hdfs_delete_dir)#删除原有文件夹
...
os.system("ssh node0 \"rm -f /proj/ccjs-PG0/p2plog/ws_order_number.log\"".format(args.wltype, args.table)) #删除原有的结果
