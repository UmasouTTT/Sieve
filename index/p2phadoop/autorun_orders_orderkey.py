...
hdfs_delete_dir = "/tpch_origin/{}".format(args.table)
hdfs_write_dir = "/tpch_origin/"
os.system("hadoop fs -rm -r -skipTrash " + hdfs_delete_dir)#删除原有文件夹
...
# 第一步，获得查询范围
simulate_file = "tpch-orders-orderkey.log"
_range_list = []
_sqls = []
...
os.system("ssh node0 \"rm -f /proj/ccjs-PG0/p2plog/orders_orderkey.log\"".format(args.wltype, args.table)) #删除原有的结果
