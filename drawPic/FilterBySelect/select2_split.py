...
axs[1].set_yticks([0.001, 0.01, 0.1, 1])
axs[1].set_yticklabels(["0.1", "1", "10", "100"], fontsize=fontsize)
...
fig.text(-0.01, 0.5, 'Scan Ratio(%)', va='center', rotation='vertical', fontsize = fontsize+1, weight = 'bold')
# axs[1].legend(['Fingerprint', 'Cuckoo', 'Sieve_0.1', 'Sieve_1', 'Sieve_10', 'Fiting-tree'], loc='center', bbox_to_anchor=(0.69, 0.83))

# 显示图形
plt.tight_layout()
plt.savefig("range0.01.pdf", bbox_inches='tight')
